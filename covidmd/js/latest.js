...
countiesData.features[1].properties.cases = 249;
countiesData.features[2].properties.cases = 427;
countiesData.features[3].properties.cases = 313;
countiesData.features[4].properties.cases = 30;
countiesData.features[5].properties.cases = 4;
countiesData.features[6].properties.cases = 129;
countiesData.features[7].properties.cases = 25;
countiesData.features[8].properties.cases = 90;
countiesData.features[9].properties.cases = 1;
countiesData.features[10].properties.cases = 54;
countiesData.features[11].properties.cases = 3;
countiesData.features[12].properties.cases = 41;
countiesData.features[13].properties.cases = 166;
countiesData.features[14].properties.cases = 5;
countiesData.features[15].properties.cases = 566;
countiesData.features[16].properties.cases = 563;
countiesData.features[17].properties.cases = 12;
countiesData.features[18].properties.cases = 30;
countiesData.features[19].properties.cases = 4;
countiesData.features[20].properties.cases = 5;
