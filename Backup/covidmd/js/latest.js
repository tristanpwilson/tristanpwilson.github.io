...
//Cases
countiesData.features[0].properties.cases = 3;
countiesData.features[1].properties.cases = 289;
countiesData.features[2].properties.cases = 491;
countiesData.features[3].properties.cases = 343;
countiesData.features[4].properties.cases = 33;
countiesData.features[5].properties.cases = 4;
countiesData.features[6].properties.cases = 134;
countiesData.features[7].properties.cases = 33;
countiesData.features[8].properties.cases = 95;
countiesData.features[9].properties.cases = 1;
countiesData.features[10].properties.cases = 73;
countiesData.features[11].properties.cases = 3;
countiesData.features[12].properties.cases = 44;
countiesData.features[13].properties.cases = 180;
countiesData.features[14].properties.cases = 5;
countiesData.features[15].properties.cases = 640;
countiesData.features[16].properties.cases = 653;
countiesData.features[17].properties.cases = 13;
countiesData.features[18].properties.cases = 34;
countiesData.features[19].properties.cases = 4;
countiesData.features[20].properties.cases = 6;
countiesData.features[21].properties.cases = 29;
countiesData.features[22].properties.cases = 8;
countiesData.features[23].properties.cases = 7;
countiesData.features[24].properties.statecases = 3125;
